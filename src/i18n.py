...
TRANSLATIONS = {
    "en": {
        ...
        "format.report_locations": "  body {body}, tables {tables}, headers/footers {hf}",
        "format.report_smart_tags": "Smart tags unwrapped: {count}",
        "format.report_proof_errors": "Stray proofing marks removed: {count}",
        "format.report_orphan_fields": "Orphaned field runs removed: {count}",
        "format.report_manual_colours": "Manual colours reset: {count}",
        ...
        "proofread.too_large": "Document exceeds the maximum supported size (5,000,000 characters).",
        "proofread.progress": "Proofreading chunk {done} of {total}…",
    ...
    "fr": {
        ...
        "format.report_locations": "  corps {body}, tableaux {tables}, en-têtes/pieds de page {hf}",
        "format.report_smart_tags": "Balises actives supprimées : {count}",
        "format.report_proof_errors": "Marques de révision parasites supprimées : {count}",
        "format.report_orphan_fields": "Séquences de champ orphelines supprimées : {count}",
        "format.report_manual_colours": "Couleurs manuelles réinitialisées : {count}",
        ...
        "proofread.too_large": "Le document dépasse la taille maximale prise en charge (5 000 000 caractères).",
        "proofread.progress": "Révision du segment {done} sur {total}…",
